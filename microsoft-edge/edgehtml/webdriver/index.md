...
| Aceitar certificados TLS não seguros | "acceptInsecureCerts"     | Sem &nbsp; suporte       | N/D               |
| Estratégia de carregamento de página               | "pageLoadStrategy"        | Com suporte                | 17763             |
| Configuração de Proxy              | proxy                   | Sem &nbsp; suporte       | N/D               |
...
| POST        | ID do/Session/{Session}/Window/fullscreen                        | [Janela de tela inteira](https://www.w3.org/TR/webdriver/#fullscreen-window)                   | Sem &nbsp; suporte | N/D               |
...
| POST        | [/Session/: Id_da_sessão/timeouts/async_script](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtimeoutsasync_script)               | Sem &nbsp; suporte | N/D               |
...
| GET         | [/Session/: Id_da_sessão/IME/available_engines](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeavailable_engines)               | Sem &nbsp; suporte | N/D               |
| GET         | [/Session/: Id_da_sessão/IME/active_engine](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeactive_engine)                       | Sem &nbsp; suporte | N/D               |
| GET         | [/Session/: Id_da_sessão/IME/Activated](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeactivated)                               | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Identificação_da_sessão/IME/desativar](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimedeactivate)                             | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/IME/Activate](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidimeactivate)                                 | Sem &nbsp; suporte | N/D               |
...
| GET         | [/Session/: Id_da_sessão/element/: ID](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidelementid)                                    | Sem &nbsp; suporte | N/D               |
...
| GET         | [/Session/: Identificação_da_sessão/orientação](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidorientation)                                  | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Identificação_da_sessão/orientação](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidorientation)                                  | Sem &nbsp; suporte | N/D               |
...
| POST        | [/Session/: Id_da_sessão/Touch/Click](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchclick)                                   | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/Touch/down](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchdown)                                     | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Identificação_da_sessão/Touch/up](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchup)                                         | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/Touch/mover](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchmove)                                     | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/Touch/Scroll](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchscroll)                                 | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/Touch/Scroll](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchscroll-1)                               | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Identificação_da_sessão/Touch/DoubleClick](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchdoubleclick)                       | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/Touch/longclick](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchlongclick)                           | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/Touch/movimento](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchflick)                                   | Sem &nbsp; suporte | N/D               |
| POST        | [/Session/: Id_da_sessão/Touch/movimento](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidtouchflick-1)                                 | Sem &nbsp; suporte | N/D               |
...
| GET         | [/Session/: Identificação_da_sessão/log](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidlog)                                                  | Sem &nbsp; suporte | N/D               |
| GET         | [/Session/: Identificação_da_sessão/log/tipos](https://github.com/SeleniumHQ/selenium/wiki/JsonWireProtocol#sessionsessionidlogtypes)                                       | Sem &nbsp; suporte | N/D               |
