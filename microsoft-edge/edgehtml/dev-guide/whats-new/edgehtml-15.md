...
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      `base-uri`, `child-src` , `form-action` `frame-ancestors` e `plugin-types` .  <!--  See [Microsoft Edge supported CSP directives](../security/content-security-policy.md) for more.  -->  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="1":::
...
O suporte do Microsoft Edge para a **API de autenticação da Web** emergente que usa a biometria do [Windows Hello](https://www.microsoft.com/windows/comprehensive-security) foi atualizado com as seguintes alterações:  
...
Para obter mais informações e o status de outros recursos do WebDriver, confira o [WebDriver](../../webdriver/index.md).  
