...
:::image type="complex" source="./media/whitepaper-media/crashes2.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/crashes2.png":::
   Falhas  
:::image-end:::  
...
Para outras plataformas ou versões do Windows 10 versão 1803 e anteriores, para visualizar os dados de diagnóstico, vá para `edge://data-viewer`. Para visualizar os dados enviados periodicamente à Microsoft desde a última vez em que o visualizador foi aberto, vá para `edge://data-viewer`. Para ver quais dados foram enviados à Microsoft para a sua sessão específica, atualize o visualizador. Os dados usados para preencher `edge://data-viewer` são armazenados localmente no dispositivo. Para limpar os dados no visualizador, feche a guia `edge://data-viewer`. 

Para nos ajudar a melhorar os produtos e serviços da Microsoft, os dados de diagnósticos não-identificados e agregados são armazenados por até dois anos. Como os dados de diagnóstico não são coletados ou armazenados com a conta Microsoft, os dados de diagnóstico não podem ser exibidos ou excluídos do [painel de privacidade da Microsoft][MicrosoftAccountPrivacy]. Para excluir os dados de diagnóstico no Windows 10, vá para **Iniciar** > **Configurações** > **Privacidade** > **Diagnóstico e comentários** e em **Excluir dados de diagnóstico** selecione **Excluir**. A funcionalidade excluir dados de diagnóstico só tem suporte no Windows 10 versão 1803 ou posterior. Para obter mais informações, confira [Diagnóstico, comentários e privacidade no Windows 10][MicrosoftSupport4468236]. 
...
:::image type="complex" source="./media/whitepaper-media/geolocation2.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/geolocation2.png":::
   Location  
:::image-end:::  
...
:::image type="complex" source="./media/whitepaper-media/migration.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/migration.png":::
   Import  
:::image-end:::  
...
:::image type="complex" source="./media/whitepaper-media/ie-mode.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/ie-mode.png":::
   Modo do IE  
:::image-end:::  
...
:::image type="complex" source="./media/whitepaper-media/n-t-p1.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/n-t-p1.png":::
   Página de nova guia  
:::image-end:::  
...
Para navegar até um site, o navegador deve pesquisar o endereço de rede (por exemplo, 93.184.216.34) para o nome do host (por exemplo, example.com) que é usado na URL do site. O DNS seguro realiza essa pesquisa usando um serviço por meio de uma conexão HTTPS com o provedor de serviços DNS, protegendo as pesquisas contra modificação ou espionagem de invasores na rede.  

Por padrão, o provedor de serviços DNS atual é usado para evitar interrupções na sua navegação. Nem todos os provedores de serviços oferecem DNS seguro. Para evitar a interrupção da sua navegação, se a conexão de DNS seguro falhar, o Microsoft Edge irá alternar e executar uma pesquisa DNS não criptografada com o seu provedor de serviços DNS atual. O Microsoft Edge permite usar um provedor de DNS seguro específico. Se um provedor de DNS seguro for escolhido, o Microsoft Edge não passará para a pesquisa DNS normal se a pesquisa segura falhar. Você pode escolher as configurações de DNS seguro em `edge://setting/privacy`.  

O DNS seguro fica desativado por padrão para computadores gerenciados que fazem parte de uma organização, mas podem ser configurados usando políticas administrativas. A navegação InPrivate usa a configuração de permissão de localização do perfil do qual a sessão InPrivate foi iniciada. O modo Convidado sempre usará o provedor de serviços atual.
...
:::image type="complex" source="./media/whitepaper-media/smart-screen.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/smart-screen.png":::
   SmartScreen  
:::image-end:::  
...
:::image type="complex" source="./media/whitepaper-media/sync.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/sync.png":::
...
:::image type="complex" source="./media/whitepaper-media/tracking-prevention.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/tracking-prevention.png":::
   Prevenção contra rastreamento  
:::image-end:::  
...
:::image type="complex" source="./media/whitepaper-media/w-i-p.png" alt-text="Barra de endereços" lightbox="./media/whitepaper-media/w-i-p.png":::
   Proteção de Informações do Windows  
:::image-end:::  
