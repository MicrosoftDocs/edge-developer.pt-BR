...
Confira o guia de [políticas de reprodução automática](./dev-guide/browser-features/autoplay-policies.md) para obter detalhes e práticas recomendadas para garantir uma boa experiência do usuário com mídia hospedada em seu site.
...
Por fim, os usuários avançados podem observar a apppearance do *Visualizador da Web de aplicativo da área de trabalho* (anteriormente chamado *Win32WebViewHost*), um aplicativo de sistema interno que representa o sistema de WebView Win32, nos seguintes locais:
