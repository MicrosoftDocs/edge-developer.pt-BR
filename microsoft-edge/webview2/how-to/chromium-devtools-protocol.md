...
1.  Para criar um aplicativo WebView2, use um dos seguintes guias de início ou exemplos webView2.  
    *   [Introdução WebView2 em Windows Forms][Webview2GetStartedWinforms]  
    *   [Introdução WebView2 no WPF][Webview2GetStartedWpf]  
