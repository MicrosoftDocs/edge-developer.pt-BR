...
## Resumo
 ...
 Parte                        | Descrições
--------------------------------|---------------------------------------------
[CreateWebView2EnvironmentWithDetails](#createwebview2environmentwithdetails) | DLL Export para criar um ambiente WebView2 com uma versão personalizada do Edge, diretório de dados do usuário e/ou opções do navegador adicional.
[CreateWebView2Environment](#createwebview2environment) | Cria um ambiente WebView2 verde usando a versão de Borda instalada.
[GetWebView2BrowserVersionInfo](#getwebview2browserversioninfo) | Obtenha as informações da versão do navegador, incluindo o nome do canal, se não for o canal estável ou a borda incorporada.
...
Se uma variável de ambiente Override for encontrada, usamos os valores browserExecutableFolder, userDataFolder e additionalBrowserArguments como substituições para os valores correspondentes nos parâmetros CreateWebView2EnvironmentWithDetails.
...
Isso equivale a chamar CreateWebView2EnvironmentWithDetails com nullptr para browserExecutableFolder, userDataFolder, additionalBrowserArguments. Consulte CreateWebView2EnvironmentWithDetails para obter mais detalhes.
...
Os nomes dos canais são beta, dev e Canárias. Se houver uma substituição para o browserExecutableFolder ou para a preferência de canal, a substituição será usada. Se não houver uma substituição, o parâmetro passado para GetWebView2BrowserVersionInfo será usado.
