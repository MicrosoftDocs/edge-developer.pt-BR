...
---
# 0.9.515-ICoreWebView2Settings de interface 
...
[get_AreRemoteObjectsAllowed](#get_areremoteobjectsallowed) | A propriedade AreRemoteObjectsAllowed é usada para controlar se os objetos de host são acessíveis a partir da página em WebView.
...
A propriedade AreRemoteObjectsAllowed é usada para controlar se os objetos de host são acessíveis a partir da página em WebView.
