...
[CreateCoreWebView2EnvironmentWithDetails](#createcorewebview2environmentwithdetails) | Esta API será removida na próxima versão do SDK.
...
Esta API será removida na próxima versão do SDK.

Use CreateCoreWebView2EnvironmentWithOptions.
