...
CoreWebView2HttpHeadersCollectionIterator | Iterador para uma coleção de cabeçalhos HTTP.
CoreWebView2HttpRequestHeaders | Cabeçalhos de solicitação HTTP.
CoreWebView2HttpResponseHeaders | Cabeçalhos de resposta HTTP.
...
CoreWebView2WebResourceRequest | Uma solicitação HTTP usada com o evento WebResourceRequested.
CoreWebView2WebResourceRequestedEventArgs | Args de evento para o evento WebResourceRequested.
CoreWebView2WebResourceResponse | Uma resposta HTTP usada com o evento WebResourceRequested.
CoreWebView2WebResourceResponseReceivedEventArgs | Args de evento para o evento WebResourceResponseReceived.
