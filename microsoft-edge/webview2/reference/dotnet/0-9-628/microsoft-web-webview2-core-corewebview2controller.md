...
[ZoomFactorChanged](#zoomfactorchanged) | ZoomFactorChanged é acionado quando a propriedade ZoomFactor do WebView é alterada.
...
É recomendável chamar Handled (verdadeiro) desde o início, como você pode saber que deseja manipular a tecla aceleradora.

#### Limites 

Os limites da WebView.

> [limites](#bounds) de retângulo público
...
No caso em que o evento MoveFocusRequested é acionado, o foco continua no WebView quando o evento MoveFocusRequested é acionado. O LostFocus só será acionado depois que o código do aplicativo ou a ação padrão do conjunto de eventos MoveFocusRequested se concentrar fora do WebView.
...
ZoomFactorChanged é acionado quando a propriedade ZoomFactor do WebView é alterada.
...
> public void [SetBoundsAndZoomFactor](#setboundsandzoomfactor)(limites de retângulo, ZoomFactor duplo)
