...
*   [AddHostObjectToScriptWithOrigins][AddHostObjectToScriptWithOriginsAPI] API promovida para estável com suporte ao elemento iFrame.
...
[NuGet pacote][NuGetGallery1.0.864.35] \| Versão mínima do Tempo de Execução a ser carregada: 86.0.616.0 ou mais recente \| Compatibilidade completa da API: 91.0.864.35 ou mais nova  
...
*   Para obter mais informações sobre como criar aplicativos WPF, navegue até o Guia de Introdução [WPF][Webview2GetStartedWpf] e a Referência [WPF][DotnetApiMicrosoftWebWebview2Wpf] WebView2 para APIs específicas do WPF.  
*   Para obter mais informações sobre Windows de formulários, navegue até o Guia Windows [Formulários Introdução e o][Webview2GetStartedWinforms] WebView2 Windows Forms [Reference][DotnetApiMicrosoftWebWebview2Winforms] para APIs específicas do Windows Forms.  
