...
> [!NOTE]
> Se você estiver baixando o SDK do Windows 10 para usar a ferramenta MakePri. exe, poderá selecionar apenas os recursos "ferramentas de assinatura do SDK do Windows para aplicativos da área de trabalho" e "SDK do Windows para aplicativos da UWP gerenciados" para manter o download mais claro. A ferramenta MakePri. exe será exibida em subpastas de C:\Program Files (x86) \Windows Kits\10\bin\10.0.17713.0.
