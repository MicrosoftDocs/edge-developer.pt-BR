...
*   O JsRT para a Windows Store só dá suporte ao Microsoft Edge Engine (chakra.dll). Os aplicativos que tentam se vincular a qualquer API do JsRT no jscript9.dll irão falhar na certificação.  
