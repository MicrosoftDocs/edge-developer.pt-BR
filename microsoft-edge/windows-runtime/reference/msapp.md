...
### <span data-ttu-id="a698a-128">createBlobFromRandomAccessStream</span><span class="sxs-lookup"><span data-stu-id="a698a-128">createBlobFromRandomAccessStream</span></span>  
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-149">Exceções</span><span class="sxs-lookup"><span data-stu-id="a698a-149">Exceptions</span></span>**  
      ...
      | <span data-ttu-id="a698a-150">Extremamente</span><span class="sxs-lookup"><span data-stu-id="a698a-150">Exception</span></span> | <span data-ttu-id="a698a-151">Condição</span><span class="sxs-lookup"><span data-stu-id="a698a-151">Condition</span></span> |  
      |:---- |:--- |  
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-162">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="a698a-162">Parameters</span></span>**  
      ...
      `object` <span data-ttu-id="a698a-163">no</span><span class="sxs-lookup"><span data-stu-id="a698a-163">[in]</span></span>  
...
### <span data-ttu-id="a698a-181">createDataPackageFromSelection</span><span class="sxs-lookup"><span data-stu-id="a698a-181">createDataPackageFromSelection</span></span>  
...
:::row:::
   ...
   :::column span="":::
      **<span data-ttu-id="a698a-192">Comentários</span><span class="sxs-lookup"><span data-stu-id="a698a-192">Remarks</span></span>**  
      ...
      <span data-ttu-id="a698a-195">Não há propriedades disponíveis para o pacote de dados retornado.</span><span class="sxs-lookup"><span data-stu-id="a698a-195">There are no available properties for the returned data package.</span></span>  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
...
:::row:::
   ...
   :::column span="":::
      **<span data-ttu-id="a698a-205">Valor de retorno</span><span class="sxs-lookup"><span data-stu-id="a698a-205">Return value</span></span>**
      ...
      <span data-ttu-id="a698a-206">Nenhum(a)</span><span class="sxs-lookup"><span data-stu-id="a698a-206">None</span></span>    
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-218">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="a698a-218">Parameters</span></span>**  
      ...
      `type` <span data-ttu-id="a698a-219">no</span><span class="sxs-lookup"><span data-stu-id="a698a-219">[in]</span></span>
...
:::row:::
   ...
   :::column span="":::
      **<span data-ttu-id="a698a-262">Valor de retorno</span><span class="sxs-lookup"><span data-stu-id="a698a-262">Return value</span></span>**  
      ...
      <span data-ttu-id="a698a-263">Esse método não retorna um valor.</span><span class="sxs-lookup"><span data-stu-id="a698a-263">This method does not return a value.</span></span>  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
...
### <span data-ttu-id="a698a-275">execAtPriority</span><span class="sxs-lookup"><span data-stu-id="a698a-275">execAtPriority</span></span>  
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-299">Exceções</span><span class="sxs-lookup"><span data-stu-id="a698a-299">Exceptions</span></span>**  
      ...
      <span data-ttu-id="a698a-300">Nenhuma.</span><span class="sxs-lookup"><span data-stu-id="a698a-300">None.</span></span>  
   :::column-end:::
   :::column span="":::
...
### <span data-ttu-id="a698a-310">getCurrentPriority</span><span class="sxs-lookup"><span data-stu-id="a698a-310">getCurrentPriority</span></span>  
...
:::row:::
   ...
   :::column span="":::
      **<span data-ttu-id="a698a-338">Valor de retorno</span><span class="sxs-lookup"><span data-stu-id="a698a-338">Return value</span></span>**
      ...
      <span data-ttu-id="a698a-339">Nenhuma.</span><span class="sxs-lookup"><span data-stu-id="a698a-339">None.</span></span>  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
...
:::row:::
   ...
   :::column span="":::
      ...
      *   <span data-ttu-id="a698a-394">Restrições de comunicação de mesma origem</span><span class="sxs-lookup"><span data-stu-id="a698a-394">Same Origin Communication Restrictions</span></span>  
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-402">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="a698a-402">Parameters</span></span>**  
      ...
      `priority` <span data-ttu-id="a698a-403">no</span><span class="sxs-lookup"><span data-stu-id="a698a-403">[in]</span></span>
...
:::row:::
   ...
   :::column span="":::
      **<span data-ttu-id="a698a-431">Comentários</span><span class="sxs-lookup"><span data-stu-id="a698a-431">Remarks</span></span>**  
      ...
      <span data-ttu-id="a698a-432">Nenhuma.</span><span class="sxs-lookup"><span data-stu-id="a698a-432">None.</span></span>  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-436">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="a698a-436">Parameters</span></span>**  
      ...
      | <span data-ttu-id="a698a-438">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-438">Type</span></span> | <span data-ttu-id="a698a-439">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-439">Description</span></span> |  
      |:---- |:--- |  
...
:::row:::
   ...
   :::column span="":::
      **<span data-ttu-id="a698a-466">Valor de retorno</span><span class="sxs-lookup"><span data-stu-id="a698a-466">Return value</span></span>**
      ...
      <span data-ttu-id="a698a-467">Nenhuma.</span><span class="sxs-lookup"><span data-stu-id="a698a-467">None.</span></span>  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-472">Exemplo</span><span class="sxs-lookup"><span data-stu-id="a698a-472">Example</span></span>**  
      
      <span data-ttu-id="a698a-473">Este exemplo chama `terminateApp` quando uma exceção é encontrada.</span><span class="sxs-lookup"><span data-stu-id="a698a-473">This example calls `terminateApp` when an exception is encountered.</span></span>  <span data-ttu-id="a698a-474">Ele usa o `Error` objeto fornecido quando você captura uma exceção.</span><span class="sxs-lookup"><span data-stu-id="a698a-474">It uses the `Error` object provided when you catch an exception.</span></span>  
...
### <span data-ttu-id="a698a-475">Constantes MSApp</span><span class="sxs-lookup"><span data-stu-id="a698a-475">MSApp Constants</span></span>  

:::row:::
   :::column span="":::
      <span data-ttu-id="a698a-476">Valores de prioridade permitidos associados a `execAsyncAtPriority` , `execAtPriority` , `getCurrentPriority` e `isTaskScheduldAtPriorityOrHigher` .</span><span class="sxs-lookup"><span data-stu-id="a698a-476">Allowed priority values associated with `execAsyncAtPriority`, `execAtPriority`, `getCurrentPriority`, and `isTaskScheduldAtPriorityOrHigher`.</span></span>  
   :::column-end:::
   :::column span="":::
      #### <span data-ttu-id="a698a-477">Atual</span><span class="sxs-lookup"><span data-stu-id="a698a-477">Current</span></span>  
      
      `current`  
      
      | <span data-ttu-id="a698a-478">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-478">Type</span></span> | <span data-ttu-id="a698a-479">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-479">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-480">DOMString</span><span class="sxs-lookup"><span data-stu-id="a698a-480">DOMString</span></span> | <span data-ttu-id="a698a-481">Quando `current` usado com o método apropriado \ (consulte também a seção \), o método usará a prioridade contextual atual ao executar a operação solicitada.</span><span class="sxs-lookup"><span data-stu-id="a698a-481">When `current` is used with the appropriate method \(See also section\), the method will use the current contextual priority when executing the requested operation.</span></span>  |  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
      #### <span data-ttu-id="a698a-482">Alto</span><span class="sxs-lookup"><span data-stu-id="a698a-482">High</span></span>  
      
      `high`  
      
      | <span data-ttu-id="a698a-483">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-483">Type</span></span> | <span data-ttu-id="a698a-484">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-484">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-485">DOMString</span><span class="sxs-lookup"><span data-stu-id="a698a-485">DOMString</span></span> | <span data-ttu-id="a698a-486">Quando `high` usado com o método apropriado \ (consulte também a seção \), o método usará maior prioridade normal ao executar a operação solicitada e enviará a operação antes de qualquer trabalho de prioridade normal existente.</span><span class="sxs-lookup"><span data-stu-id="a698a-486">When `high` is used with the appropriate method \(See also section\), the method will use higher than normal priority when executing the requested operation and will be dispatch the operation before any existing normal priority work.</span></span>  |  
   :::column-end:::
   :::column span="":::
      #### <span data-ttu-id="a698a-487">Ocioso</span><span class="sxs-lookup"><span data-stu-id="a698a-487">Idle</span></span>  
      
      `idle`  
      
      | <span data-ttu-id="a698a-488">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-488">Type</span></span> | <span data-ttu-id="a698a-489">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-489">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-490">DOMString</span><span class="sxs-lookup"><span data-stu-id="a698a-490">DOMString</span></span> | <span data-ttu-id="a698a-491">Quando `ideal` usado com o método apropriado \ (consulte também a seção \), o método usará a prioridade mais baixa do que o normal ao executar a operação solicitada e enviará a operação após qualquer trabalho normal de prioridade existente.</span><span class="sxs-lookup"><span data-stu-id="a698a-491">When `ideal` is used with the appropriate method \(See also section\), the method will use lower than normal priority when executing the requested operation and will be dispatch the operation after any existing normal priority work.</span></span>  |  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
      #### <span data-ttu-id="a698a-492">Normal</span><span class="sxs-lookup"><span data-stu-id="a698a-492">Normal</span></span>  
      
      `normal`  
      
      | <span data-ttu-id="a698a-493">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-493">Type</span></span> | <span data-ttu-id="a698a-494">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-494">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-495">DOMString</span><span class="sxs-lookup"><span data-stu-id="a698a-495">DOMString</span></span> | <span data-ttu-id="a698a-496">Quando `normal` usado com o método apropriado (consulte também a seção), o método usará a prioridade existente normal ao executar a operação solicitada.</span><span class="sxs-lookup"><span data-stu-id="a698a-496">When `normal` is used with the appropriate method (See also section), the method will use the normal existing priority when executing the requested operation.</span></span>  |  
   :::column-end:::
   :::column span="":::
      **<span data-ttu-id="a698a-497">Exemplo</span><span class="sxs-lookup"><span data-stu-id="a698a-497">Example</span></span>**  
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-498">Requisitos</span><span class="sxs-lookup"><span data-stu-id="a698a-498">Requirements</span></span>**  
      
      | <span data-ttu-id="a698a-499">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-499">Type</span></span> | <span data-ttu-id="a698a-500">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-500">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-501">IDL</span><span class="sxs-lookup"><span data-stu-id="a698a-501">IDL</span></span> | <span data-ttu-id="a698a-502">Mshtml. idl</span><span class="sxs-lookup"><span data-stu-id="a698a-502">Mshtml.idl</span></span> |  
   :::column-end:::
   :::column span="":::
      &nbsp;  
   :::column-end:::
...
## <span data-ttu-id="a698a-503">MSAppAsyncOperation</span><span class="sxs-lookup"><span data-stu-id="a698a-503">MSAppAsyncOperation</span></span>  
...
### <span data-ttu-id="a698a-504">start</span><span class="sxs-lookup"><span data-stu-id="a698a-504">start</span></span>  

:::row:::
   :::column span="":::
      <span data-ttu-id="a698a-505">Inicia o `MSAppAsyncOperation` .</span><span class="sxs-lookup"><span data-stu-id="a698a-505">Starts the `MSAppAsyncOperation`.</span></span>  
   :::column-end:::
   :::column span="":::
      ```javascript
...
:::row:::
   :::column span="":::
      **<span data-ttu-id="a698a-506">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="a698a-506">Parameters</span></span>**  
      
      <span data-ttu-id="a698a-507">Nenhuma.</span><span class="sxs-lookup"><span data-stu-id="a698a-507">None.</span></span>  
   :::column-end:::
   :::column span="":::
      **<span data-ttu-id="a698a-508">Valor de retorno</span><span class="sxs-lookup"><span data-stu-id="a698a-508">Return value</span></span>**
      
      <span data-ttu-id="a698a-509">Nenhuma.</span><span class="sxs-lookup"><span data-stu-id="a698a-509">None.</span></span>  
   :::column-end:::
:::row-end:::  
:::row:::
   :::column span="":::
      
      **<span data-ttu-id="a698a-510">Propriedades</span><span class="sxs-lookup"><span data-stu-id="a698a-510">Properties</span></span>**  
      
      `error` <span data-ttu-id="a698a-511">folha</span><span class="sxs-lookup"><span data-stu-id="a698a-511">property</span></span>  
      
      | <span data-ttu-id="a698a-512">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-512">Type</span></span> | <span data-ttu-id="a698a-513">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-513">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-514">DOMError</span><span class="sxs-lookup"><span data-stu-id="a698a-514">DOMError</span></span> | <span data-ttu-id="a698a-515">Representa um erro em `MSAppAsyncOperation` .</span><span class="sxs-lookup"><span data-stu-id="a698a-515">Represents an error in `MSAppAsyncOperation`.</span></span>  |  
      
      ```javascript
      p = object.error
      ```  
      
      `oncomplete` <span data-ttu-id="a698a-516">folha</span><span class="sxs-lookup"><span data-stu-id="a698a-516">property</span></span>  
      
      | <span data-ttu-id="a698a-517">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-517">Type</span></span> | <span data-ttu-id="a698a-518">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-518">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-519">EventHandler</span><span class="sxs-lookup"><span data-stu-id="a698a-519">EventHandler</span></span> | <span data-ttu-id="a698a-520">Propriedade para definir um manipulador de eventos na conclusão de `MSAppAsyncOperation` .</span><span class="sxs-lookup"><span data-stu-id="a698a-520">Property for setting an event handler on completion of `MSAppAsyncOperation`.</span></span>  |  
      
      ```javascript
      p = object.oncomplete
      ```  
      
      `onerror` <span data-ttu-id="a698a-521">folha</span><span class="sxs-lookup"><span data-stu-id="a698a-521">property</span></span>  
      
      | <span data-ttu-id="a698a-522">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-522">Type</span></span> | <span data-ttu-id="a698a-523">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-523">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-524">EventHandler</span><span class="sxs-lookup"><span data-stu-id="a698a-524">EventHandler</span></span> | <span data-ttu-id="a698a-525">Propriedade para definir um manipulador de eventos em um erro durante `MSAppAsyncOperation` .</span><span class="sxs-lookup"><span data-stu-id="a698a-525">Property for setting an event handler upon an error during `MSAppAsyncOperation`.</span></span>  |  
      
      ```javascript
      p = object.onerror
      ```  
      
      `readyState` <span data-ttu-id="a698a-526">folha</span><span class="sxs-lookup"><span data-stu-id="a698a-526">property</span></span>  
      
      | <span data-ttu-id="a698a-527">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-527">Type</span></span> | <span data-ttu-id="a698a-528">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-528">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-529">Número</span><span class="sxs-lookup"><span data-stu-id="a698a-529">Number</span></span> | <span data-ttu-id="a698a-530">Representa o estado da operação assíncrona dentro do aplicativo do Windows usando JavaScript.</span><span class="sxs-lookup"><span data-stu-id="a698a-530">Represents the state of the asynchronous operation within the Windows app using JavaScript.</span></span>  <span data-ttu-id="a698a-531">Os valores incluem: `Started[0]` , `Completed[1]` , `Error[2]` .</span><span class="sxs-lookup"><span data-stu-id="a698a-531">Values include: `Started[0]`, `Completed[1]`, `Error[2]`.</span></span>  |  
      
      ```javascript
      p = object.readyState
      ```  
      
      `result` <span data-ttu-id="a698a-532">folha</span><span class="sxs-lookup"><span data-stu-id="a698a-532">property</span></span>  
      
      | <span data-ttu-id="a698a-533">Tipo</span><span class="sxs-lookup"><span data-stu-id="a698a-533">Type</span></span> | <span data-ttu-id="a698a-534">Descrição</span><span class="sxs-lookup"><span data-stu-id="a698a-534">Description</span></span> |  
      |:---- |:--- |  
      | <span data-ttu-id="a698a-535">Qualquer</span><span class="sxs-lookup"><span data-stu-id="a698a-535">Any</span></span> |<span data-ttu-id="a698a-536">Representa o resultado de `MSAppAsyncOperation` .</span><span class="sxs-lookup"><span data-stu-id="a698a-536">Represents the result of `MSAppAsyncOperation`.</span></span>  |  
